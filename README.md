...
`https://www.kgeorgiy.info/git-students/year2024/<USER>/java-advanced`,
 ...
 * Клонируйте ваш личный репозиторий
    * `git clone https://www.kgeorgiy.info/git-students/year2024/<USER>/java-advanced`
 ...
 * Добавьте ссылку на исходный репозиторий
    * `git remote add source https://www.kgeorgiy.info/git/geo/java-advanced-2026-students`
    * Теперь можно будет забирать обновления командой `git pull source main`.
 ...
 * Перед отправкой решения на проверку
    ...
    * Закоммитьте все изменения в `main`.
